...
set FILES_DIR "[pwd]/k401tFM2SubsystemFiles"
set CONSTRAINTS_FILE "${FILES_DIR}/k401tFM2Constraints.xdc"
set DESIGN_WRAPPER_FILE "${FILES_DIR}/k401tFM2DesignWrapper.v"
set MIG_FILE "${FILES_DIR}/k401tFM2DdrConfiguration.prj"

set BOARDPATH "[pwd]/k401tFM2SubsystemFiles/boards"
if {[file exists ${BOARDPATH}/]} {
    set_param board.repoPaths $BOARDPATH
...
proc generateProject {constraintsFile designWrapperFile migFile} {
  ...
  set PART "xc7k410tffg900-2"
  set BOARD "xilinx.com:kintex7:k410tFM2:1.0"
